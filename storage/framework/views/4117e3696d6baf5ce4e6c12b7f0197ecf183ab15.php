...
<body class="bg-black h-screen antialiased leading-none font-sans">
    <div id="app">
        <header class="bg-black py-6">      NAVIERA PEP
            <div class="container mx-auto flex justify-between items-center px-6">
                <div>
                    <a href="<?php echo e(url('/')); ?>" class="text-lg font-semibold text-gray-300 no-underline">
                ...
                <nav class="space-x-4 text-gray-300 text-sm sm:text-base">
                    ...
                    <a href="/local offices">Local offices</a>
...
<?php /**PATH C:\xampp\htdocs\Proyecto_Final_B67057_B65642\resources\views/layouts/app.blade.php ENDPATH**/ ?>